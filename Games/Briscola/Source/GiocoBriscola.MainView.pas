...
type
  ...
  private
    FBriscolaEngine: TBriscolaEngine;
    procedure StartGame;
...
procedure TMainView.DisegnaCartaDelGiocatore( ACard: TCard; APlayer: Integer; ACardOfPlayer: Integer );
begin
  gCardTable.MoveTo( ACard, gPosition[APlayer,ACardOfPlayer].X, gPosition[APlayer,ACardOfPlayer].Y );
end;

procedure TMainView.MuoviCartaDelGiocatore( ACard: TCard; APlayer: Integer; ACardOfPlayer: Integer );
begin
  gCardTable.MoveTo( ACard, gPositionPlayedCards[APlayer].X, gPositionPlayedCards[APlayer].Y )
end;

procedure TMainView.GiraCarta( ACard: TCard );
begin
  gCardTable.TurnOverCard(ACard);
end;

procedure TMainView.miEsciClick(Sender: TObject);
begin
  Self.Close;
end;

procedure TMainView.NuovaPartita;
begin
  Inizializzazione;
  StartGame;
end;

procedure TMainView.miInformazioniClick(Sender: TObject);
begin
...
procedure TMainView.CardTableCardClickEvent(ACard: TCard;
  Button: TMouseButton);
begin
...
procedure TMainView.miNuovaPartitaClick(Sender: TObject);
begin
  NuovaPartita;
end;
...
procedure TMainView.BuildCardTable;
begin
  if gCardTable = nil then
  begin
...
begin
  ...
  FBriscolaEngine := TBriscolaEngine.Create;
...
begin
  FBriscolaEngine.Free;
end;

procedure TMainView.CardTableCardRestoredEvent;
...
procedure TMainView.Inizializzazione;
begin
