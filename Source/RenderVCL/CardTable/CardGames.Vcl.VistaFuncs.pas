...
var
  CheckOSVerForFonts: Boolean = False;//Set true for vista only change.
                                      //Now if Vista or font is present on XP
                                      //will switch fonts.
implementation
...
procedure SetVistaFonts(const AForm: TCustomForm);
//Hard coded switch to Segoe UI. Use instead of SetDesktopIconFonts.
begin
...
procedure SetDesktopIconFonts(const AFont: TFont);
//Changes font to system desktop font. Use instead of SetVistaFonts.
var
  LogFont: TLogFont;
begin
